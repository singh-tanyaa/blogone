  ...
  <Link href="/login" className={styles.loginButton}>
      ...
      Already registered? <span className={styles.loginButtonText}>Login</span>
          ...
          <div className={styles.modalRight}>
            <img
              src="https://images.unsplash.com/photo-1507208773393-40d9fc670acf?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Event"
            />
          </div>
        </div>
